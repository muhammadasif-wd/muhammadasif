...
const Events = () => {
  ...
  return (
    <div className="xl:grid-cols-2 place-content-center place-items-start grid gap-10">
      <div className="xl:order-1 order-2">
        <article>
          ...
          <article className="text-zinc-500 mt-10 space-y-5 leading-relaxed">
        ...
        <Button
          as={Link}
          className="bg-primary text-light dark:bg-light dark:text-primary mt-5 font-bold"
          href="/about/events"
          radius="sm"
          size="lg"
        >
