    ...
    <div className="container min-h-screen mx-auto">
      <div className="relative overflow-hidden">
        <div className="text-center">
          <h1 className="sm:text-6xl dark:text-light text-secondary text-4xl font-bold">Gallery</h1>

          <p className="dark:text-light/70 text-secondary mt-3">
            Dive into my gallery, a vibrant showcase of my passion for photography!
          </p>
